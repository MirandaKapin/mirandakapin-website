                ...
                <div className="row">
                  ...
                  <div className="medium-9 small-12 columns">
                    <div className="main-header">
                      <h2><strong>Miranda Kapin</strong></h2>
                ...
                <div className="row">
                  <div className="small-12 columns">
                    <div className="large-text about">
                      Web Developer and Product Leader. Experienced with all stages of the development cycle for both B2B and B2C Web Applications.
